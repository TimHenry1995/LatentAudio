...
def run(pca_dimensionality:int = 64, sample_size = 2048, latent_data_folder:str=None, figure_output_folder:str=None):
    """
    ...
    :param pca_dimensionality: The desired output dimensionality of the layerwise PCA-models (default is 64). This must not exceed the original dimensionality of Yamnet's layers. The layer with smallest original dimensionality is the last layer that uses 1024 dimensions.
    :type pca_dimensionality: int, optional
    :param sample_size: The number of instances (sounds) that shall be sampled from the data (default is 2048).
